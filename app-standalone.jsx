    ...
    return (
      <section id="top" style={{
        ...
        <div className="grain" style={{
          ...
          backgroundImage: `url(${window.__resources.proposalSmile})`,
      ...
      <div style={{ maxWidth: 1240, margin: '0 auto' }}>
        ...
        <div className="stack-md" style={{
          ...
          <figure style={{ margin: 0 }}>
            <div style={{
              backgroundImage: `url(${window.__resources.proposalWide})`,
        ...
        <div className="stack-md" style={{
          ...
          <figure style={{ margin: 0 }}>
            <div style={{
              backgroundImage: `url(${window.__resources.proposalTears})`,
              backgroundSize: 'cover', backgroundPosition: 'center',
              aspectRatio: '3/2',
              position: 'relative',
            }} className="grain" />
        ...
        <div className="stack-md" style={{
          ...
          {[
            window.__resources.proposalHug,
            window.__resources.proposalRing,
            window.__resources.proposalMoment,
          ].map((src) => (
          ...
          <div style={{
            ...
            <div style={{ padding: 40 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
                ...
                <Row k="Attire" v="Semi-formal. For the men, a suit or blazer and trousers in navy, charcoal or black. For the women, dresses below the knee." />
...
function FAQ() {
  ...
  const items = [
    ['What should I wear?', 'Semi-formal attire. For the men, a suit or blazer and trousers in navy, charcoal or black. For the women, dresses below the knee. It\'s an outdoor, barn-style reception on grass, so consider your heels.'],
            ...
            <div style={{ display: 'flex', gap: 14, marginTop: 40 }}>
              ...
              <button type="submit" disabled={attending === null}
                style={{
                  ...
                  background: 'var(--camel)', color: 'var(--cream)',
                  border: 'none', cursor: attending !== null ? 'pointer' : 'not-allowed',
                  fontSize: 10, letterSpacing: '0.3em', textTransform: 'uppercase',
                  opacity: attending !== null ? 1 : 0.4, whiteSpace: 'nowrap',
                }}>
                Send reply
              </button>
            </div>
